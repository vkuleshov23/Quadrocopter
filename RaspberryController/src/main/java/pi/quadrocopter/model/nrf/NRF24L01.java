 ...
 */
public class NRF24L01 implements Runnable {
     ...
     */
    private static final short RECEIVE_DATA_WIDTH = 32;
    /**
     ...
     */
    private NRFReceiveListener listener=new EmptyNRFReceiveListener();
    /**
    ...
    public static final short NOP = 0xff;// NULL operation
         ...
         * @param l NRFReceiveListener which is callback function on data received
         */
        public final void setNRFReceiveListener(NRFReceiveListener l) {
            this.listener = l;
        }
        /**
         * remove NRFReceiveListener, class will use EmptyNRFReceiveListener which will only print byte recevied to stdout
         */
        public final void removeNRFReceiveListener(){
            this.listener = new EmptyNRFReceiveListener();
        }
        /**
         * one default data listener, it is empty, just print out bytes in console
         */
        private final class EmptyNRFReceiveListener implements NRFReceiveListener {
